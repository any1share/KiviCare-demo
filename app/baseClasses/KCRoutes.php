...
class KCRoutes {
	public function routes() {
		...
		return array(
            ...
            'get_doctor_workdays'         => [ 'method' => 'post', 'action' => 'KCDoctorController@getDoctorWorkdays' ],
            ...
            'restrict_appointment_edit' => [ 'method' => 'post', 'action' => 'KCAppointmentController@restrictAppointmentEdit'],
            'get_multifile_upload_status' => [ 'method' => 'post', 'action' => 'KCAppointmentController@getMultifileUploadStatus'],
            'change_multifile_upload_status' => [ 'method' => 'post', 'action' => 'KCAppointmentController@saveMultifileUploadStatus'],
            'appointment_reminder_notificatio_save' => [ 'method' => 'post', 'action' => 'KCAppointmentController@appointmentReminderNotificatioSave'],
            'get_appointment_reminder_notification' => [ 'method' => 'post', 'action' => 'KCAppointmentController@getAppointmentReminderNotification'],
			...
			'prescription_mail'         =>  [ 'method' => 'post', 'action' => 'KCPatientPrescriptionController@mailPrescription' ],
            ...
            'check_if_clinic_have_session' =>  [ 'method' => 'post', 'action' => 'KCHomeController@checkIfClinicHaveSession' ],
			...
			'forgetPassword'  =>  [ 'method' => 'post', 'action' => 'KCAuthController@forgetPassword' , 'nonce' => 0],
			...
			'sms_status_change' => [ 'method' => 'post', 'action' => 'KCHomeController@enableDisableSMS', 'nonce' => 0],
			...
			'whatsapp_status_change' => [ 'method' => 'post', 'action' => 'KCHomeController@enableDisableWhatsapp', 'nonce' => 0],
			'whatsapp_config_save'   => [ 'method' => 'post', 'action' => 'KCLanguageController@saveWhatsAppConfig', 'nonce' => 0],
			'get_whatsapp_config'   => [ 'method' => 'post', 'action' => 'KCLanguageController@editWhatsAppConfig', 'nonce' => 0],
			...
			'get_iunderstnad_loco_translate' =>             [ 'method' => 'post', 'action' => 'KCLanguageController@getiUnderstand' ],
